                    ...
                    <div class="col-md-12"> 
                        <div class="form-group">
                            <div class="text-center">
                                ...
                                <label for="" class="text-center">Foto Iklan</label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group required">
                                    ...
                                    <input type="text" id="nama_iklan" name="nama_iklan" class="form-control" placeholder="Nama Iklan" autofocus="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group required">
        ...
        if (idiklan != "") {
            ...
            $.ajax({
                ...
                .done(function(result) {
                    $('#idiklan').val(result.idiklan);
                    $('#nama_iklan').val(result.nama_iklan);
                    $('#url').val(result.url);
                    $('#status').val(result.status);
                    $('#file_lama').val(result.file);

                    if (result.file != '' && result.file != null) {
                        $("#output1").attr("src", "<?php echo (base_url('./uploads/iklan/thumbnails')) ?>/" + result.file);
                    } else {
            ...
            $('#form').bootstrapValidator({
                ...
                fields: {
                    nama_iklan: {
                        validators: {
                            notEmpty: {
                                message: 'Nama Iklan tidak boleh kosong'
                            },
                            stringLength: {
                                min: 3,
                                max: 100,
            ...
            $('#lbljudul').html('Tambah Data Iklan');
        } //end !ltambah    
