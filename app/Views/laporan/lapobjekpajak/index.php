      ...
      <div class="col-md-12">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info">LAPORAN OBJEK PAJAK</h6>
          </div>
          <div class="card-body">
            ...
            <form action="<?php echo (site_url('laporan/lapobjekpajak')) ?>" class="" method="post" id="myForm">
                        ...
                        <table border="1" cellpadding="5" width="100%" style="border-color:#e3e6f0;">
                          ...
                          <tbody>
                            ...
                            foreach ($rsData->getResult() as $data) {
                              ...
                              // Mengambil dan menghitung nilai objek pajak
                              ...
                              if ($akunlevel3 == 1) {
                                if ($data->level != 4) {
                                  ...
                                  <tr>
                                    ...
                                    <td style="' . $font . ' text-align:right;">' . ((($data->kdakun != '70000') || ($data->kdakun != '700000')) && $data->level != 1  ? ($objek_pajak >= 0 ? number_format($objek_pajak, 0, ",", ".") : "(" . number_format($objek_pajak * -1, 0, ",", ".") . ")") : "") . '</td>
                                    <td style="' . $font . ' text-align:right;">' . ((($data->kdakun != '70000') || ($data->kdakun != '700000')) && $data->level != 1  ? ($objek >= 0 ? number_format($objek, 0, ",", ".") : "(" . number_format($objek * -1, 0, ",", ".") . ")") : "") . '</td>
                                  </tr>';
                                }
                              } else {
                              ...
                              if ($data->kdakun == "730000" || $data->kdakun == "73000") {
                                ...
                                echo '
                                  <tr height="25" style="">
                                    ...
                                    <td style="font-size: 13px; text-align:right;">' . ($objek_pajak >= 0 ? number_format($objek_pajak, 0, ",", ".") : "(" . number_format($objek_pajak * -1, 0, ",", ".") . ")") . '</td>
                                    <td style="font-size: 13px; text-align:right;">' . ($objek >= 0 ? number_format($objek, 0, ",", ".") : "(" . number_format($objek * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                              }
                            }
...
<script type="text/javascript">
  ...
  $('#cetak').click(function() {
    ...
    if ($("#akunlevel3").is(':checked')) {
      ...
      var akunlevel3 = '0';
        ...
        var url = "<?php echo site_url('laporan/lapobjekpajak-cetak/') ?>" + tglawal + "/" + tglakhir + "/" + akunlevel3 + "/" + idperusahaan;
        $(".isiKonten").html(`
            <div class="modal-header">
                <h5 class="modal-title">Laporan Objek Pajak</h5>
  ...
  $('#cetakexcel').click(function() {
    ...
    window.open("<?php echo site_url('laporan/lapobjekpajak-excel/') ?>" + tglawal + "/" + tglakhir + "/" + akunlevel3 + "/" + idperusahaan);
    location.reload();
  });
