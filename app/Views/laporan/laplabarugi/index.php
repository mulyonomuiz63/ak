      ...
      <div class="col-md-12">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info">LAPORAN LABA RUGI</h6>
          </div>
          <div class="card-body">
            ...
            <form action="<?php echo (site_url('laporan/laplabarugi')) ?>" class="" method="post" id="myForm">
                          ...
                          <tbody>
                              ...
                              if ((substr($kdakun_old, 0, 1) != substr($data->kdakun, 0, 1)) && $kdakun_old != '' && substr($kdakun_old, 0, 1) != '7') {
                                echo '
                                  <tr height="30">
                                    ...
                                    <td style="background-color: #e6f5fe; font-size: 15px; font-weight: bold; text-align:left;">' . $totaldesc . '</td>
                                    <td style="background-color: #e6f5fe; font-size: 15px; font-weight: bold; text-align:right;">' . ($totalrupiah >= 0 ? number_format($totalrupiah, 0, ",", ".") : "(" . number_format($totalrupiah * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                                ...
                                if ($totaldesc == "TOTAL HARGA POKOK PENJUALAN") {
                                  ...
                                  <tr height="30" >
                                    <td style="border-right-color: #e6f5fe;background-color: #e6f5fe;"></td>
                                    <td style="background-color: #e6f5fe; font-size: 15px; font-weight: bold; text-align:left;">TOTAL LABA RUGI KOTOR</td>
                                    <td style="background-color: #e6f5fe; font-size: 15px; font-weight: bold; text-align:right;">' . ($totallabarugi >= 0 ? number_format($totallabarugi, 0, ",", ".") : "(" . number_format($totallabarugi * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                                }
                            ...
                            if ($totaldesc2 != "TOTAL BEBAN LAINNYA") {
                              echo '
                                  <tr height="30">
                                    <td style="border-right-color:#e6f5fe;background-color: #e6f5fe;"></td>
                                    <td style="background-color: #e6f5fe; font-size: 15px; font-weight: bold; text-align:left;">' . $totaldesc2 . '</td>
                                    <td style="background-color: #e6f5fe; font-size: 15px; font-weight: bold; text-align:right;">' . ($totalrupiah >= 0 ? number_format($totalrupiah, 0, ",", ".") : "(" . number_format($totalrupiah * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                            }
                            $totalsebelumpajak = $totalpendapatan - $totalpengeluaran;
                            echo '
                                  <tr height="30" style="background-color: #e6f5fe;">
                                    <td style="border-right-color:#fff;"></td>
                                    <td style="font-size: 15px; font-weight: bold; text-align:left;">LABA (RUGI) SEBELUM PAJAK PENGHASILAN</td>
                                    <td style="font-size: 15px; font-weight: bold; text-align:right;">' . ($totalsebelumpajak >= 0 ? number_format($totalsebelumpajak, 0, ",", ".") : "(" . number_format($totalsebelumpajak * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                              ...
                              if ($data->kdakun == "730000" || $data->kdakun == "73000") {
                                ...
                                echo '
                                  <tr height="30" style="">
                                    ...
                                    <td style="font-size: 15px; text-align:right;">' . ($data->jumlah >= 0 ? number_format($data->jumlah, 0, ",", ".") : "(" . number_format($data->jumlah * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                              }
                            }
                            ...
                            echo '
                                  <tr height="30" style="background-color: #e6f5fe;">
                                    <td style="border-right-color:#fff;"></td>
                                    <td style="font-size: 15px; font-weight: bold; text-align:left;">LABA (RUGI) SETELAH PAJAK PENGHASILAN</td>
                                    <td style="font-size: 15px; font-weight: bold; text-align:right;">' . ($totallabasetelahpajak >= 0 ? number_format($totallabasetelahpajak, 0, ",", ".") : "(" . number_format($totallabasetelahpajak * -1, 0, ",", ".") . ")") . '</td>
                                  </tr>';
                            echo ' </tbody>
                                </table>';
                            ?>
...
<script type="text/javascript">
  ...
  $('#cetakexcel').click(function() {
    ...
    window.open("<?php echo site_url('laporan/laplabarugi-excel/') ?>" + tglawal + "/" + tglakhir + "/" + akunlevel3 + "/" + idperusahaan);
    location.reload();
  });
