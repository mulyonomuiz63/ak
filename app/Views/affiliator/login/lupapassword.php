...
<head>
  ...
  <meta name="description" content="Jangan bimbang kalau lupa password">
  <meta name="keywords" content="">
  <meta name="author" content="Akuntanmu">

  <title>Reset Password | Software Akuntansi Online Berstandar</title>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form action=""></form>
                  <form action="<?php echo (site_url('Affiliator/Login/kirimresetpassword')) ?>" class="user" method="post" id="form">
                    <?php
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="email" name="email" aria-describedby="emailHelp" placeholder="Email" autofocus="">
                    </div>
