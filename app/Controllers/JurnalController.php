...

{
	...
	public function lihat($idjurnal)
    {
        ...
        $file_pembuat = (file_exists($path_ttd_pembuat) && $file_ttd != '') ? '<img src="' . $path_ttd_pembuat . '" width="80" />' : '';
        $file_pemeriksa = (file_exists($path_ttd_pemeriksa) && $pic_ttd != '') ? '<img src="' . $path_ttd_pemeriksa . '" width="80" />' : '';
        ...
        $table .= '<td width="25%" style="border:1px solid gray; text-align:center; vertical-align:middle; height:80px;"><br><br>' . $file_pembuat . '<br><br></td>';
