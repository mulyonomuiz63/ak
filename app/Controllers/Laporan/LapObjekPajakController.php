...
class LapObjekPajakController extends BaseController
{
	...
	public function index()
	{
		...
		$data['rsData'] = $this->laporan_model->get_lapobjekpajak($tglawal, $tglakhir, $idperusahaan);

		return view('laporan/lapobjekpajak/index', $data);
	}

	public function lapObjekPajakCetak($tglawal, $tglakhir, $akunlevel3, $idperusahaan)
    {
        ...
        $rsData = $this->laporan_model->get_lapobjekpajak($tglawal, $tglakhir, $idperusahaan);

        $pdf = new \App\Libraries\Pdf('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false, $namaperusahaan, 'LAPORAN OBJEK PAJAK', $periode);
        ...
        <table border="1" cellpadding="4">
            <thead>
                <tr style="background-color:#055F93; color: white; font-weight: bold; text-align: center;">
                    ...
                    <th width="20%">Pembukuan</th>
                    <th width="20%">Objek Pajak</th>
        ...
        while ($data = $rsData->getUnbufferedRow()) {
            ...
            $objek_pajak = isset($data->objek_pajak) ? (float)$data->objek_pajak : 0;
            $objek = (float)$data->jumlah - $objek_pajak;
            ...
            if ((substr($kdakun_old, 0, 1) != substr($data->kdakun, 0, 1)) && $kdakun_old != '' && substr($kdakun_old, 0, 1) != '7') {
                $htmlChunk .= '
                        <tr style="background-color: #E5E4E2;">
                            ...
                            <td width="20%" style="font-weight: bold; text-align:right;">' . ($totalrupiah >= 0 ? number_format($totalrupiah, 0, ",", ".") : "(" . number_format($totalrupiah * -1, 0, ",", ".") . ")") . '</td>
                ...
                if ($totaldesc == "TOTAL HARGA POKOK PENJUALAN") {
                    ...
                    $htmlChunk .= '
                        <tr style="background-color: #E5E4E2;">
                            ...
                            <td width="20%" style="font-weight: bold; text-align:right;">' . ($totallabarugikotor >= 0 ? number_format($totallabarugikotor, 0, ",", ".") : "(" . number_format($totallabarugikotor * -1, 0, ",", ".") . ")") . '</td>
                            <td width="40%" colspan="2"></td>
                        </tr>';
                }
                $totalrupiah = 0;
            ...
            if ($data->kdakun == "730000" || $data->kdakun == "73000") {
                $pajakHtmlPdf = '
                        <tr style="color:#000000;">
                            ...
                            <td width="20%" style="text-align:right;">' . ($data->jumlah >= 0 ? number_format($data->jumlah, 0, ",", ".") : "(" . number_format($data->jumlah * -1, 0, ",", ".") . ")") . '</td>
                            <td width="20%" style="text-align:right;">' . ($objek_pajak >= 0 ? number_format($objek_pajak, 0, ",", ".") : "(" . number_format($objek_pajak * -1, 0, ",", ".") . ")") . '</td>
                            <td width="20%" style="text-align:right;">' . ($objek >= 0 ? number_format($objek, 0, ",", ".") : "(" . number_format($objek * -1, 0, ",", ".") . ")") . '</td>
                        </tr>';
            }
            ...
            if ($akunlevel3 == 1) {
                if ($data->level != 4) {
                    $htmlChunk .= '
                        <tr>
                            <td width="40%" style="' . $font . ' text-align:left;">' . $spasi . $data->kdakun . ' - ' . $data->nmakun . '</td>
                            <td width="20%" style="' . $font . ' text-align:right;">' . ($data->kdakun != '70000' && $data->level != 1 ? ($data->jumlah >= 0 ? number_format($data->jumlah, 0, ",", ".") : "(" . number_format($data->jumlah * -1, 0, ",", ".") . ")") : "") . '</td>
                            <td width="20%" style="' . $font . ' text-align:right;">' . ($data->kdakun != '70000' && $data->level != 1 ? ($objek_pajak >= 0 ? number_format($objek_pajak, 0, ",", ".") : "(" . number_format($objek_pajak * -1, 0, ",", ".") . ")") : "") . '</td>
                            <td width="20%" style="' . $font . ' text-align:right;">' . ($data->kdakun != '70000' && $data->level != 1 ? ($objek >= 0 ? number_format($objek, 0, ",", ".") : "(" . number_format($objek * -1, 0, ",", ".") . ")") : "") . '</td>
                        </tr>';
                }
            } else {
                if ($data->kdakun != "730000" && $data->kdakun != "73000") {
                    ...
                    <tr>
                        <td width="40%" style="' . $font . ' text-align:left;">' . $spasi . $data->kdakun . ' - ' . $data->nmakun . '</td>
                        <td width="20%" style="' . $font . ' text-align:right;">' . ($data->kdakun != '70000' && $data->level == 4 ? ($data->jumlah >= 0 ? number_format($data->jumlah, 0, ",", ".") : "(" . number_format($data->jumlah * -1, 0, ",", ".") . ")") : "") . '</td>
                        <td width="20%" style="' . $font . ' text-align:right;">' . ($data->kdakun != '70000' && $data->level == 4 ? ($objek_pajak >= 0 ? number_format($objek_pajak, 0, ",", ".") : "(" . number_format($objek_pajak * -1, 0, ",", ".") . ")") : "") . '</td>
                        <td width="20%" style="' . $font . ' text-align:right;">' . ($data->kdakun != '70000' && $data->level == 4 ? ($objek >= 0 ? number_format($objek, 0, ",", ".") : "(" . number_format($objek * -1, 0, ",", ".") . ")") : "") . '</td>
                    </tr>';
                }
            }
        ...
        $htmlChunk .= '
                        <tr style="background-color:#E5E4E2; color:#000000;">
                            ...
                            <td width="20%" style="font-weight: bold; text-align:right;">' . ($totallabasebelumpajak >= 0 ? number_format($totallabasebelumpajak, 0, ",", ".") : "(" . number_format($totallabasebelumpajak * -1, 0, ",", ".") . ")") . '</td>
                            <td width="40%" colspan="2"></td>
                        </tr>';
        ...
        $htmlChunk .= '
                        <tr style="background-color:#055F93; color:#ffffff;">
                            ...
                            <td width="20%" style="font-weight: bold; text-align:right;">' . ($totallabasetelahpajak >= 0 ? number_format($totallabasetelahpajak, 0, ",", ".") : "(" . number_format($totallabasetelahpajak * -1, 0, ",", ".") . ")") . '</td>
                            <td width="40%" colspan="2"></td>
                        </tr>';
        ...
        $namaFile = 'Laporan Objek Pajak'.$namaCetak.' ' . $namaPerusahaan . ' ' . $bulantahun . '.pdf';
        $pdf->Output($namaFile, 'I');
        exit;
    }


	public function lapObjekPajakExcel($tglawal, $tglakhir, $akunlevel3, $idperusahaan)
    {
        $menuaktif = 'lapobjekpajak';
        ...
        $namaPerusahaan = ucwords(strtolower($namaperusahaan));
        $namaPerusahaan = preg_replace(['/\bPt\b/', '/\bCv\b/'], ['PT', 'CV'], $namaPerusahaan);
        $namaFile = 'Laporan Objek Pajak' . $namaCetak . ' ' . $namaPerusahaan . ' ' . $bulantahun . '.xls';
        ...
        // KOP LAPORAN DI TENGAH (Membagi rata berdasarkan colspan='5')
        ...
        echo ".col-num { width: 140px; text-align: right; }"; // Untuk 3 kolom angka
        ...
        echo "<table>";
        echo "<tr class='kop-laporan'><th colspan='5' style='font-size: 16px; font-weight:bold;'>{$namaperusahaan}</th></tr>";
        echo "<tr class='kop-laporan'><th colspan='5' style='font-size: 14px; font-weight:bold;'>LAPORAN OBJEK PAJAK{$namaCetak}</th></tr>";
        echo "<tr class='kop-laporan'><th colspan='5' style='font-size: 12px;'>Periode {$Periode}</th></tr>";
        echo "<tr><td colspan='5' style='border:none;'></td></tr>"; // Baris kosong pemisah
        
        // Header Utama Tabel (Disesuaikan menjadi 5 kolom)
        echo "<tr class='header-tabel'>";
        echo "<th class='col-kode'>KODE AKUN</th>";
        echo "<th class='col-akun'>NAMA AKUN</th>";
        echo "<th class='col-num'>PEMBUKUAN</th>";
        echo "<th class='col-num'>OBJEK PAJAK</th>";
        echo "<th class='col-num'>SELISIH</th>";
        echo "</tr>";
        ...
        while ($data = $rsData->getUnbufferedRow()) {
            ...
            if ((substr($kdakun_old, 0, 1) != substr($data->kdakun, 0, 1)) && $kdakun_old != '' && substr($kdakun_old, 0, 1) != '7') {
                ...
                echo "<td colspan='2'></td>"; // Kolom kosong agar tabel tidak geser
                echo "</tr>";
            ...
            // TANGKAP STRUKTUR HTML PAJAK UNTUK DICETAK DI AKHIR (Sesuai 5 Kolom)
            if ($data->kdakun == "730000" || $data->kdakun == "73000") {
                ...
                $pajakRowHtml .= "<td class='col-num' style='mso-number-format:\"\#\,\#\#0;\(\#\,\#\#0\)\";'>{$objek_pajak}</td>";
                $pajakRowHtml .= "<td class='col-num' style='mso-number-format:\"\#\,\#\#0;\(\#\,\#\#0\)\";'>{$objek}</td>";
                $pajakRowHtml .= "</tr>";
            }
            ...
            if ((substr($kdakun_old, 0, 1) != substr($data->kdakun, 0, 1)) && $kdakun_old != '') {
                echo "<tr><td colspan='5' style='border:none;'></td></tr>"; // Baris pemisah kosong disesuaikan
            }
            ...
            if ($akunlevel3 == 1) {
                if ($data->level != '4') {
                    ...
                    if ($nilai !== '') {
                        ...
                        echo "<td class='col-num' style='mso-number-format:\"\#\,\#\#0;\(\#\,\#\#0\)\";'>{$objek_pajak}</td>";
                        echo "<td class='col-num' style='mso-number-format:\"\#\,\#\#0;\(\#\,\#\#0\)\";'>{$objek}</td>";
                    } else {
                        echo "<td></td><td></td><td></td>"; // Tepat 3 kolom kosong agar pas 5 kolom
                    }
                    echo "</tr>";
                }
            } else {
            ...
            // Pengosongan RAM server bertahap
        ...
        echo "<tr><td colspan='5' style='border:none;'></td></tr>"; // Baris Jeda Kosong
